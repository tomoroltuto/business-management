...
public class UserScheduleRepositoryTest {
  ...
  void すべてのユーザーと作業予定が取得できること() {
    ...
    assertThat(userSchedules).hasSize(3).contains((new UserSchedule(1L, "○○○会社", "瀬川",
        ...
        (new UserSchedule(2L, "△△△会社", "瀬川2",
            List.of(new ScheduleEntity(2L, 2, LocalDate.of(2022, 12, 7), "3階和室", "配線", 5),
                (new ScheduleEntity(3L, 2, LocalDate.of(2022, 12, 10), "3階トイレ２", "BOX取り付け",
                    2))))), (new UserSchedule(3L, "xxx会社", "瀬川2",
  ...
  void 存在するユーザーと作業予定のIDを指定してユーザーが取得できること() {
    ...
    assertThat(userSchedule).isEqualTo(new UserSchedule(2L, "△△△会社", "瀬川2",
        List.of(new ScheduleEntity(2L, 2, LocalDate.of(2022, 12, 7), "3階和室", "配線", 5),
