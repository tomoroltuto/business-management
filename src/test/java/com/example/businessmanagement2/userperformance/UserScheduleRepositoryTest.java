...
public class UserScheduleRepositoryTest {
  ...
  void すべてのユーザーと作業実績が取得できること() {
    ...
    assertThat(userPerformances).hasSize(3)
        .contains(
            (new UserPerformance(1L, "○○○会社", "瀬川", List.of(new PerformanceEntity(1L, 1, LocalDate.of(2022, 12, 6), "4階トイレ", "墨出し", 3)))),
            (new UserPerformance(2L, "△△△会社", "瀬川2", List.of(new PerformanceEntity(2L, 2, LocalDate.of(2022, 12, 7), "3階和室", "配線", 5), (new PerformanceEntity(3L, 2, LocalDate.of(2022, 12, 10), "3階トイレ２", "BOX取り付け", 2))))),
            (new UserPerformance(3L, "xxx会社", "瀬川3", List.of(new PerformanceEntity(4L, 3, LocalDate.of(2022, 12, 9), "4階洋室", "配管", 4)))));
  }
  ...
  void 存在するユーザーと作業実績のIDを指定してユーザーが取得できること() {
    ...
    assertThat(userPerformance).isEqualTo
            (new UserPerformance(2L, "△△△会社", "瀬川2", List.of(new PerformanceEntity(2L, 2, LocalDate.of(2022, 12, 7), "3階和室", "配線", 5), (new PerformanceEntity(3L, 2, LocalDate.of(2022, 12, 10), "3階トイレ２", "BOX取り付け", 2)))));
  }
}
